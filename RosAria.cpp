...
#include "PioneerTuneBehaviourDriver.hpp"
...
/*KL*/
int RosAriaNode::Setup(ArRobot *robot_ptr)
/*KL*/
...
int main( int argc, char** argv )
{
  ...
  tune[6]=20;  tune[7]=77;
  tune[8]=10;  tune[9]=62;
  tune[10]=20; tune[11]=70;

  robot_->lock();
  robot_->comStrN(ArCommands::SAY,tune,12);
  robot_->unlock();
  */
  PioneerTuneBehaviourDriver *tuneBehaviour_;
  tuneBehaviour_ = new PioneerTuneBehaviourDriver( robot_, "behaviourXML/tune/" );

  tuneBehaviour_->resetBehaviour();
  tuneBehaviour_->performBehaviour(2);

  ArUtil::sleep(5000);
  tuneBehaviour_->resetBehaviour();
  tuneBehaviour_->performBehaviour(3);

  ArUtil::sleep(5000);
  tuneBehaviour_->resetBehaviour();
  tuneBehaviour_->performBehaviour(4);

  ArUtil::sleep(5000);
  tuneBehaviour_->resetBehaviour();
  tuneBehaviour_->performBehaviour(5);
